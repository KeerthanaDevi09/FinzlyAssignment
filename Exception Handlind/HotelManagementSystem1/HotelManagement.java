...
public class HotelManagement {
	public static void main(String[] args) {
	 ...
	 private static void hireEmployee(EmployeeManagement employeeManager, Scanner scanner) {
	 ...
	 private static void listEmployeesByCategory(EmployeeManagement employeeManager, Scanner scanner) {
		...
		private static void assignTask(TaskManager taskManager, Scanner scanner) {
		...
		private static void listTasksByCategory(TaskManager taskManager, Scanner scanner) {
		...
		private static boolean isValidCategory(String category) {
		    // Define the valid categories in lowercase
